...
func TestTransferDemo(t *testing.T) {
	...
	metaTxMessage := &metax.MetaTxMessage{
		...
		TokenGasPrice: "0",
		BatchId:       big.NewInt(0),
		BatchNonce:    big.NewInt(18),
		Deadline:      big.NewInt(1684809984),
		Data:          "",
	}
	...
	typedDataHash, _ := typedData.HashStruct(typedData.PrimaryType, typedData.Message)
	signature := hexutil.MustDecode("0x6475738bbab87cd3f2a5de4ff8aa9baaaa6e801edbe825dcdb89b4a02dbbd07e726970c9ecc8880053bf75a49d93e7e60805f006516c2f6ddac65127a927048d1c")
	fmt.Println(signature)
